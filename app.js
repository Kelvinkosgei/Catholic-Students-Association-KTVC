...
// Announcements
const announcements = [
  "Welcome new members! Registration is open for 2025.",
  "Sunday mass at the college chapel: Every week at 10 AM.",
  "Annual retreat registration closes on Sept 30.",
  "Charity fundraising drive starts on Oct 15."
];
...
const urgentNotifications = [
  "🚨 Urgent: Mass at 5 PM today in the Main Chapel!",
  "⚠️ Reminder: Registration deadline is tomorrow!",
  "🙏 Join us for Rosary prayers this Friday evening.",
  "📢 Important: Meeting with new members after Sunday mass."
];
